...
app.get('/admin/edit', passportConfig.isAuthenticated, passportConfig.isAdmin, urlController.edit)
app.get('/admin/edit/:slug', passportConfig.isAuthenticated, passportConfig.isAdmin, urlController.edit)
app.post('/admin/edit', passportConfig.isAuthenticated, passportConfig.isAdmin, urlController.postNewUrl)
app.post('/admin/edit/:slug', passportConfig.isAuthenticated, passportConfig.isAdmin, urlController.postUpdateUrl)
app.post('/admin/edit/:slug/delete', passportConfig.isAuthenticated, passportConfig.isAdmin, urlController.postDeleteUrl)
...
app.post('/admin/users', passportConfig.isAuthenticated, passportConfig.isAdmin, userController.updateUserAdmins)
